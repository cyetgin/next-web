...
const BrainCircuitIcon = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
...
const technologiesList = [
    ...
    },
    {
        ...
        icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(BrainCircuitIcon, {}, void 0, false, {
            fileName: "[project]/src/app/page.tsx",
            lineNumber: 58,
            columnNumber: 40
        }, this)
...
function HomePage() {
    ...
    const [metricsData, setMetricsData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialPlatformMetrics);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchTariffQueries = async ()=>{
            try {
                ...
                setMetricsData((prevMetrics)=>prevMetrics.map((metric)=>metric.labelKey === 'home.metrics.tariffQueries' ? {
                            ...metric,
        ...
        const fetchLogicustProductCount = async ()=>{
            try {
                ...
                setMetricsData((prevMetrics)=>prevMetrics.map((metric)=>metric.labelKey === 'home.metrics.logicustProducts' ? {
                            ...metric,
                            value: count.toLocaleString()
                        } : metric));
            } catch (error) {
        ...
        const fetchTranscodeDeclarationCount = async ()=>{
            try {
                ...
                setMetricsData((prevMetrics)=>prevMetrics.map((metric)=>metric.labelKey === 'home.metrics.transcodeTransitDeclarations' ? {
                            ...metric,
                            value: data
                        } : metric));
            } catch (error) {
        ...
        const fetchDeclarantAIDocumentCount = async ()=>{
            try {
                ...
                setMetricsData((prevMetrics)=>prevMetrics.map((metric)=>metric.labelKey === 'home.metrics.declarantDeclarantAI' ? {
                            ...metric,
                            value: count.toLocaleString()
                        } : metric));
            } catch (error) {
        ...
        const fetchShieldAIDeclarationsCount = async ()=>{
            try {
                ...
                setMetricsData((prevMetrics)=>prevMetrics.map((metric)=>metric.labelKey === 'home.metrics.shieldAIDeclarationsControlled' ? {
                            ...metric,
                            value: count.toLocaleString()
                        } : metric));
            } catch (error) {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: technologiesList.map((tech, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("inline-flex items-center gap-2 text-sm font-medium text-accent-foreground bg-accent px-3 py-1 rounded-full", "transition-all duration-500 ease-out", animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4', `delay-[${index * 150}ms]`),
                                    style: {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardHeader"], {
                                            ...
                                            children: metric.imageUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                                ...
                                                lineNumber: 429,
                                                columnNumber: 21
                                            }, this) : metric.Icon ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(metric.Icon, {
...
//# sourceMappingURL=_4bc1878f._.js.map