...
export type TranslationKey =
  ...
  // Metrics Section
  | 'home.metrics.title'
  | 'home.metrics.tariffQueries'
  | 'home.metrics.tariffUsers'
  | 'home.metrics.logicustProducts'
  | 'home.metrics.transcodeTransitDeclarations'
  | 'home.metrics.transcodeTransitAI'
  | 'home.metrics.declarantCustomsDeclarations'
  | 'home.metrics.declarantDeclarantAI'
  | 'home.metrics.shieldAIDeclarationsControlled'
  | 'about.title'
  | 'about.mission.title'
  ...
  | 'settings.cookies.status.accepted'
  | 'settings.cookies.status.rejected'
  | 'settings.cookies.status.notSet'
