...
>(({ className, onClick, children, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      {...props}
    >
      {children ?? ( // Use children if provided, otherwise default icon
        <>
          <PanelLeft />
...
const SidebarMenuSubItem = forwardRef<
  HTMLLIElement,
  ComponentProps<"li">
>(({ className, ...props }, ref) => <li ref={ref} className={cn(className)} {...props} />) // Added cn() for consistency
SidebarMenuSubItem.displayName = "SidebarMenuSubItem"

const SidebarMenuSubButton = forwardRef<
  HTMLAnchorElement, // Assuming it's an anchor, adjust if button or other
  ComponentProps<"a"> & { // Assuming it's an anchor
    asChild?: boolean
    size?: "sm" | "md"
    isActive?: boolean
  }
>(({ asChild = false, size = "md", isActive, className, children, ...props }, ref) => { // Added children
  const Comp = asChild ? Slot : "a" // Assuming 'a' tag
